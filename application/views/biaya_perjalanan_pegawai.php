                        ...
                        <td>
                          ...
                          foreach ($perjalanan_dinas as $data_perjalanan_dinas) {
                            ...
                            if ($data_perjalanan_dinas->nominal_biaya_mobil==NULL) {
                              echo "Biaya Trasnportasi Mobil : Rp 0,-  <br>";
                              $total_anggaran+=0;
                            }
                            else{
                              echo "Biaya Trasnportasi Mobil : Rp " . (INT)$data_perjalanan_dinas->nominal_biaya_mobil*(INT)$data_perjalanan_dinas->jarak_perjalanan . ',-<br>';
                            ...
                            if ($data_perjalanan_dinas->kelas_transportasi==NULL) {
                              echo "Biaya Trasnportasi Bukan Mobil : -  <br>" ;
                            }
                            else {
                             echo "Biaya Trasnportasi Bukan Mobil : Rp " . $data_perjalanan_dinas->kelas_transportasi . ',-<br>';
                           }
                          ...
                          foreach($pegawai_pengikut as $data_pegawai_pengikut){
                            ...
                            if ($data_pegawai_pengikut->nominal_biaya_mobil==NULL) {
                              ...
                              echo "Biaya Trasnportasi Mobil : Rp " . (INT)$data_pegawai_pengikut->nominal_biaya_mobil*(INT)$data_perjalanan_dinas->jarak_perjalanan . ',-<br>';
                            ...
                            if ($data_pegawai_pengikut->kelas_transportasi==NULL) {
                             ...
                             echo "Biaya Trasnportasi Bukan Mobil : Rp " . $data_pegawai_pengikut->kelas_transportasi . ',-<br>';
                           }
